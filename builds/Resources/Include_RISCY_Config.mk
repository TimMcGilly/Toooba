...
DATA_PREFETCHER_TYPE ?= DEPENDENCE_PREFETCHER
...
ifeq (,$(filter $(DATA_PREFETCHER_TYPE),MARKOV MARKOV_ON_HIT MARKOV_ON_HIT_2 BLOCK STRIDE STRIDE_ADAPTIVE ALL_IN_CAP CHERI_STRIDE CHERI_STRIDE_MIX SPP CAP_SPATIAL CAP_PTR MEASURER CAP_SPATIAL_PTR LOGGING CAP_PC_BACKWARDS ALL_PREFETCH_FILTER DEPENDENCE_PREFETCHER))
...
BSC_COMPILATION_FLAGS += \
	...
	-D DATA_PREFETCHER_IN_LL \
	-D DATA_PREFETCHER_LOGGING_EXTRA \
	-D CAP128 \
	-D MEM512 \
	-D RISCV \
	-D TSO_MM \
