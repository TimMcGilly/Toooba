...
DATA_PREFETCHER_TYPE ?= CAP_PC_BACKWARDS
...
ifeq (,$(filter $(DATA_PREFETCHER_TYPE),MARKOV MARKOV_ON_HIT MARKOV_ON_HIT_2 BLOCK STRIDE STRIDE_ADAPTIVE ALL_IN_CAP CHERI_STRIDE CHERI_STRIDE_MIX SPP CAP_SPATIAL CAP_PTR MEASURER CAP_SPATIAL_PTR LOGGING CAP_PC_BACKWARDS))
